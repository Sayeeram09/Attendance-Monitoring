...
<html>
 ...
 <body style="background-color:lightgrey;">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Attendance Monitoring</a>
        </div>
  ...
  <div class="container">
    <h2 style="margin-top:70px;">For Students</h2>
    ...
    <table class="table table-bordered table-striped">
      ...
      <tbody>
        <tr>
          <td style="background-image:url('img/sr1.jpg'); background-size:cover;">
            <form id="login">
          ...
          <td style="background-image:url('img/sr2.jpg'); background-size:cover;">
            <form id="signup">
              <div class="form-group">
                <label>Name</label>
