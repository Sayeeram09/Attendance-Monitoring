<html>
 ...
 <body style="background-image:url('img/sr5.jpg'); background-size:cover;">
   <!-- Fixed navbar -->
 ...
 <div class="container">
  ...
  <form id="getAttendance">
    <div class="form-group">
      <label style="color:white;">Year of course</label>
    ...
    <div class="form-group">
      <label style="color:white;">Subject Code of Course</label>
